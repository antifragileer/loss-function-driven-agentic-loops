...
# (11 in 2.1.0/2.2.0; 12 in 2.3.0+; 2.3.1 widens the gate trigger; 2.3.2 hardens the gate as a precondition; 2.4.0 makes skills self-contained; 2.4.1 strips dead LFD-doc citations; 2.4.2 cleans up frameworks.md tail; 2.5.0 adds preflight.sh to meta-skill)
