...
| [`lfd-thinking-protocols`](./skills/lfd-thinking-protocols) | 0.4.0 | Gate — 10 thinking protocols the meta-skill invokes between Rounds 0-7 (meta-session helper, not loaded by the loop) | optional |
