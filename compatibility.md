...
| `lfd-thinking-protocols` | 0.3.0 | gate (10 thinking protocols the meta-skill invokes between Rounds 0-7) | optional — meta-session helper, not loaded by the loop session |
...
*expected* to work but are *not verified* as of v2.3.2.
